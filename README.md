...
Spernakit v3.47.1 is the current template baseline. Changes must follow the architecture rules in the
template docs, stay wired end to end, and pass the quality gates before they are treated as
complete.

## Overview

Spernakit v3.47.1 is a full-stack self-hosted admin application template for building
