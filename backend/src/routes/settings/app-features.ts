...
const ALL_SETTING_DEFAULTS: SeedDefaultEntry[] = [
	...
	{
		description: 'Application super-theme (UI paradigm)',
		key: APP_FEATURES_KEYS.superTheme,
		value: APP_FEATURES_DEFAULTS.superTheme,
	},
	{
...
function getAppFeatures(): {
	...
	const superThemeRaw = settingsMap.get(APP_FEATURES_KEYS.superTheme)?.value;
	const superTheme = parseStringSetting(superThemeRaw, APP_FEATURES_KEYS.superTheme, 'default', [
		'default',
		'terminal',
		'bbs',
	]);
