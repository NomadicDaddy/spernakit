...
const HealthCheckConfigSchema = z.object({
	...
	alertThreshold: z.enum(['degraded', 'unhealthy']).optional(),
	diskSpaceDegradedThreshold: z.number().optional(),
	diskSpaceUnhealthyThreshold: z.number().optional(),
	enabled: z.record(z.string(), z.boolean()).optional(),
	logRetentionDays: z.number().optional(),
	memoryHeapDegradedThreshold: z.number().optional(),
	memoryHeapUnhealthyThreshold: z.number().optional(),
});
