...
This guide shows you how to extend and customize the Spernakit template for your application.

## Table of Contents

1. [Core vs App-Specific Code Organization](#core-vs-app-specific-code-organization)
2. [Application Branding](#application-branding)
...
8. [Customizing User Profiles](#customizing-user-profiles)
9. [Verifying Your Customizations](#verifying-your-customizations)
10. [Frontend Architecture Components](#frontend-architecture-components)
...
Spernakit v3 uses Elysia routes directly; there is no separate controllers directory. Business logic goes in services, and route handlers stay thin:
