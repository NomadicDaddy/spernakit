...
- **Bun 1.3.10+** ([Install Bun](https://bun.sh)) - Required package manager
...
```bash
# Check Node.js version (should be 22+, 22 LTS recommended)
node --version
...
The `smoke:qc` quality gate runs the following checks:

- ✅ Drift Check - Detect template drift from Spernakit core
- ✅ Application Check - Verify application-level consistency
- ✅ Typecheck - Verify TypeScript compilation
- ✅ Lint - Check code quality
- ✅ Build - Ensure production build succeeds
- ✅ API Types Check - Validate OpenAPI spec against frontend types
- ✅ Format - Validate code formatting
- ✅ Dependency Check - Verify dependency versions
