...
> **As of v3.13.0-lts (2026-06-29):** every dependency listed below is pinned to the exact versions captured in package.json files. Updates are scoped to security advisories per [docs/template/LTS.md](LTS.md).
