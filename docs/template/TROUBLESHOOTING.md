...
### Problem: Bun version incompatibility
...
> Node.js is optional - Spernakit runs on Bun and pins no Node version. Install Node.js only if you rely on npm-based tooling.
