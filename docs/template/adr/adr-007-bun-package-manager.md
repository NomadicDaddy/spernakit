...
- **Bun 1.4.2+** (Required package manager and runtime)
...
- **Monorepo support**: Workspaces work with no extra setup
...
1. **Version Pinning**: Use `bun: ">=1.4.2"` in engines to prevent incompatible versions
