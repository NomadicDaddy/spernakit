...
> **Note:** Drizzle schema definitions live in two directories: `backend/src/db/schema/` for SQLite and `backend/src/db/schema-pg/` for PostgreSQL. Both define the same logical schema using their respective Drizzle dialect.
