...
High-level view of how the Spernakit application is composed and deployed.

## Container Architecture

A single Docker container runs two processes managed by supervisord:
...
Every HTTP request follows this path through the middleware stack:
