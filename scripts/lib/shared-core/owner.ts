 ...
 *
 * This is the rule fleet-gate-layer-design.md 3a specified as a loader rule and it is not one, for
 * a reason worth stating: `loadManifest` is handed the running repository's `scripts/`, while a group's hook body
