...
21. `bun run test:fleet-manifest-sync`
    - Fleet manifest writer regression self-test.
22. `bun run check:fleet-manifest`
    - Fleet manifest matches packages and runtime configs.
23. `bun run check:image-publication`
