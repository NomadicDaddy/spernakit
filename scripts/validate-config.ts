 ...
 *
 * Validates three config files against the Zod config schema:
 *
 ...
 *
 * Why validate all three: Zod schemas evolve faster than JSON files. When a
 * new required field is added to a Zod schema, it's easy to forget to update
